...
exports.main = async () => { try { const res=await db.collection('grammar_topics').limit(100).get(); return ok(res.data.length?res.data:mock.grammarTopics); } catch(e) { return ok(mock.grammarTopics); } };
